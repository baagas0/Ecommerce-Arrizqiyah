...
class ProfilesController extends Controller
{
    ...
    public function show($username)
    {
        ...
        return view('login.profiles.show')->with($data);
    }
    ...
    public function edit($username)
    {
        try {
            ...
            return view('login.pages.status')
        ...
        return view('login.profiles.edit')->with($data);
    }
    ...
    public function update(UpdateUserProfile $request, $username)
    {
        ...
        return redirect('member-area/profile/'.$user->name.'/edit')->with('success', trans('profile.updateSuccess'));
    }
    ...
    public function updateUserAccount(Request $request, $id)
    {
        ...
        return redirect('member-area/profile/'.$user->name.'/edit')->with('success', trans('profile.updateAccountSuccess'));
    }
    ...
    public function updateUserPassword(UpdateUserPasswordRequest $request, $id)
    {
        ...
        return redirect('member-area/profile/'.$user->name.'/edit')->with('success', trans('profile.updatePWSuccess'));
    }
    ...
    public function deleteUserAccount(DeleteUserAccount $request, $id)
    {
        ...
        if ($user->id != $currentUser->id) {
            return redirect('member-area/profile/'.$user->name.'/edit')->with('error', trans('profile.errorDeleteNotYour'));
        }

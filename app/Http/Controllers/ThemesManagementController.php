...
class ThemesManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('login.themesmanagement.show-themes', compact('themes', 'users'));
    }
    ...
    {
        return view('login.themesmanagement.add-theme');
    }
    ...
    {
        return view('login.themesmanagement.show-theme')->with($this->getThemeData($theme));
    }
    ...
    {
        return view('login.themesmanagement.edit-theme')->with($this->getThemeData($theme));
    }

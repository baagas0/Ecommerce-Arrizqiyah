...
@push('css')
<!-- Plugins css -->
<link href="{{ asset('xoric/libs/dropzone/min/dropzone.min.css') }}" rel="stylesheet" type="text/css" />
@endpush
@push('js')
<!-- dropzone js -->
<script src="{{ asset('xoric/libs/dropzone/min/dropzone.min.js') }}"></script>
@endpush
    ...
    <div class="card">
        <div class="card-body">
            @if ($user->profile)
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-4 col-md-4 mt-3 profile-sidebar text-white rounded-left-sm-up">
                        ...
                        <div class="col-12 col-sm-8 col-md-8">
                            <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-sm-12">
                                            <div id="">
                                                ...
                                                <div class="collapseTwo card-collapse collapse show">
                                                    <div class="card-body">
                                                        <div class="dz-preview"></div>
                                                        {!! Form::open(array('route' => 'avatar.upload', 'method' => 'POST', 'name' => 'avatarDropzone','id' => 'avatarDropzone', 'class' => 'form single-dropzone dropzone single', 'files' => false)) !!}
                                                ...
                                                {{-- <div class="row" data-toggle="buttons">
                                                    <div class="col-6 col-xs-6 right-btn-container">
                                                        <label class="btn btn-primary @if($user->profile->avatar_status == 0) active @endif btn-block btn-sm" data-toggle="collapse" data-target=".collapseOne:not(.show), .collapseTwo.show">
                                                            <input type="radio" name="avatar_status" id="option1" autocomplete="off" value="0" @if($user->profile->avatar_status == 0) checked @endif> Remove Avatar
                                                        </label>
                                                    </div>
                                ...
                                <div class="tab-pane fade mt-3 edit-account-tab" role="tabpanel" aria-labelledby="edit-account-tab">
...
@section('footer_scripts')
    ...
    @include('login.scripts.form-modal-script')

    @if(config('settings.googleMapsAPIStatus'))
        @include('login.scripts.gmaps-address-lookup-api3')
    @endif

    @include('login.scripts.user-avatar-dz')
